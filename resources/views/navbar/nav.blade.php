...
<body>
    ...
    @guest
                ...
                <form class="form-inline my-2 my-lg-0 search-form" id="friendSearchForm" action="{{ route('friends.search') }}" method="GET">
                    ...
                    <button class="btn btn-outline-success my-2 my-sm-0 btn-search" type="submit" id="searchButton"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-search" viewBox="0 0 16 16">
